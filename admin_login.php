    ...
    <div id="loadingScreen" class="loading-overlay">
        <div class="loading-content">
            <div class="loading-glow-card">
                ...
                <p class="loading-subtext">Connecting<span class="loading-dots"></span></p>
    ...
    <div class="card max-w-md w-full" style="opacity: 0; transition: opacity 0.3s ease-in;">
        ...
        <form method="POST" action="">
            <div class="mb-6">
                ...
                <input type="text" id="staff_id" name="staff_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm hover:shadow-md transition-all duration-200" placeholder="Enter your Staff ID" required>
            </div>
