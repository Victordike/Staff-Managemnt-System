        ...
        <form method="POST" action="">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-0">
                    <input type="password" id="password" name="password" class="input-field flex-1 rounded-none rounded-l-lg focus:outline-none" placeholder="Enter your password" required>
